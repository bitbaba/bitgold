...
static unsigned int CalculateNextWorkRequiredV2(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
/**
 * @brief GetNextWorkRequiredV2, retarget every one block, since sha256q hard-fork point.
 * @param pindexLast
 * @param pblock
 * @param params
 * @return
